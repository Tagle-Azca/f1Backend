...
async function seedDrivers(raceId, sessionKey) {
...
async function seedLapsAndPositions(raceId, sessionKey, drivers) {
...
async function seedPitStops(raceId, sessionKey) {
  try {
...
async function seedStints(raceId, sessionKey) {
  try {
